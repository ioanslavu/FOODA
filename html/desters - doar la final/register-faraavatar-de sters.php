<?php
 ...
 if (isset($_POST['submit'])) {
  ...
  $rez2 = mysqli_query($dbconfig, $queryemail);
  ...
  if ($rezultate1[0]) {
    ...
    if ($rezultate2[0]) {
      ...
      $query = "INSERT INTO users (id, nume, prenume, email, oras, username, password, datareg, lastseen, ad) VALUES (default, '$nume', '$prenume', '$email', '$oras', '$username', '$password', '$data $time', '$data $time', 0)";
      ...
      if($result) {
        ...
        $fmsg ="Eroare la creare utilizator! Incercati din nou!";
      }
    }
  }
