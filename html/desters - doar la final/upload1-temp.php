<?php
 ...
 $idcateg = explode("-", $url, 3)[1];
 $idfel = explode("-", $url, 3)[2];
 ...
 // if everything is ok, try to upload file
   ...
   if (move_uploaded_file($_FILES["upload"]["tmp_name"], $target_file)) {
     ...
     if (isset($_POST['submite'])) {
       ...
       $queryupload = "INSERT INTO `poze` (id, poza, id_resto, id_categ, id_fel, id_user, data, nota) VALUES (default, '$poza', $idresto, $idcateg, $idfel, $iduser[0], '$data $time', 9)";
