...
<body>
 ...
 <div class="navprof">
   <a href="login/reset.php">Resetare parola</a><br><br>
   <a href="login/avatarchange.php">Schimba avatar</a><br><br>
   <a href="javascript: void(0);" id="mycomm" onclick="MyComments();">Comentariile mele</a><br><br>
