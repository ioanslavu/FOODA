<?php
 ...
 $queryuser = "SELECT id, nume, prenume, oras, datareg, lastseen, avatar FROM users WHERE username = '$login_session'";
 ...
 echo "<table id='profilother'>
  <tr>
   <td rowspan='4'><div id='profilepoza'><img src='avatars/" . $rez[6]. "'></div></td>
   <td>Utilizator:</td>
   <td>" . $rez[1]. " " . $rez[2]. "</td>
  </tr>
  <tr>
