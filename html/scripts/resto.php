<?php
 ...
 document.getElementById('adr').innerHTML = '$rezultat[3]<br>Tel: $rezultat[5]&nbsp;&nbsp;<a href=\'tel:$rezultat[5]\'><img id=\'phone\' src=\'/img/phone.png\'></a><br><br>$rezultat[4]<br><br>Latitudine: $rezultat[8] N<br>Longitudine: $rezultat[9] E';
 ...
 if (isset($_POST['fav'])) {
     $query = "UPDATE restos SET fav = ($rezultat[12]+1) WHERE id = $idresto";
     $result = mysqli_query($dbconfig, $query);
 }
